    ...
    <>
      ...
      <div className="w-12/12 flex flex-col items-center">
        <div className="w-10/12 md:w-6/12">
          ...
          />
          <AccordionComponent
            question={"¿Qué medidas de seguridad implementa Yasound para proteger mis datos personales y financieros?"}
            answer={
          ...
          />
          <AccordionComponent
            question={"¿Cómo puedo contactar al equipo de soporte de Yasound si surge algún problema o tengo alguna pregunta?"}
            answer={
          ...
          />
          <AccordionComponent
            question={"¿Qué sucede si experimento algún problema con una transacción o una compra en Yasound?"}
            answer={
          ...
          />
          <AccordionComponent
            question={"¿Ofrece Yasound alguna garantía de calidad para los beats y productos disponibles en la plataforma?"}
            answer={
